    ...
    <body id="page-top">
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <img src="img/image.png" alt="" height="220"width="220"/>
                        <h3 class="mx-auto my-0 text-uppercase"></h3>
                        <h2 class="text-white-50 mx-auto mt-2 mb-5"></h2>
                        <a class="btn btn-info" href="#about">Conocenos</a>
                    </div>
                </div>
            </div>
        </header>
        ...
        <section class="about-section text-center" id="about">
            <div class="container px-4 px-lg-5">
                ...
                <img  class="img-fluid" src="img/IMAGEN_PERSONAS.jpg" alt="" height="500" width="550"/>
            </div>
        </section>
        <!-- Projects-->
